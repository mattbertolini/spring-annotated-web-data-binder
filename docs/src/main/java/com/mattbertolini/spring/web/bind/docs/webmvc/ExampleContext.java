...
import com.mattbertolini.spring.web.bind.docs.ExampleService;
...
public class ExampleContext {
    ...
    // end::javaMvcConfiguration[]

    @Bean
    public ExampleController exampleController(ExampleService exampleService) {
