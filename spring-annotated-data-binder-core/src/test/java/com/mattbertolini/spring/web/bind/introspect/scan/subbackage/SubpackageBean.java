...
package com.mattbertolini.spring.web.bind.introspect.scan.subbackage;
...
public class SubpackageBean {
    ...
    public void setSubpackageProperty(String subpackageProperty) {
        this.subpackageProperty = subpackageProperty;
    }
}
